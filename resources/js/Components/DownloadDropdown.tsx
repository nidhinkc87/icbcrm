...
export default function DownloadDropdown({ onPdf, onExcel, label = 'Download' }: { onPdf: () => void; onExcel: () => void; label?: string }) {
    ...
    return (
        ...
        >
            <button
                ...
                className="inline-flex items-center gap-1.5 rounded-md bg-gray-700 px-4 py-2 text-sm font-medium text-white hover:bg-gray-800"
            >
                {label}
            ...
            {open && (
                <div className="absolute right-0 z-10 mt-1 w-36 rounded-md bg-white shadow-lg ring-1 ring-black/5">
                    <button onClick={() => { onPdf(); setOpen(false); }} className="flex w-full items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                    ...
                    <button onClick={() => { onExcel(); setOpen(false); }} className="flex w-full items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
