...
export default function Edit({ rule, document_types, services, employees }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(route('admin.expiry-rules.update', rule.id));
    };

    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Edit Expiry Rule</h2>}>
            <Head title="Edit Expiry Rule" />
                    ...
                    <div className="overflow-hidden bg-white p-6 shadow-sm sm:rounded-lg">
                        <form onSubmit={submit}>
                            ...
                            <div className="mt-8 flex items-center justify-end space-x-4 border-t border-gray-200 pt-6">
                                ...
                                <PrimaryButton disabled={processing}>Update Rule</PrimaryButton>
                            </div>
                        </form>
                    </div>
                </div>
